...
const MovieDetails = () => {
  ...
  const {axios,image_base_url,shows,getToken,user,fetchFavouriteMovies,FavouriteMovies} = useAppContext();
    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3 '>
          ...
          <p className='text-gra-400 mt-2 text-sm leading-tight max-w-xl'>{show.movie.overview}</p>
          <p> {timeFormat(show.movie.runtime)}~
